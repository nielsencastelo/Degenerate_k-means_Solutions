% The k-means algorithm with iterative First Improving to remove the degeneracy
...
function [classe,centros,it,rein] = kme(x,k,centros,epsilon,metodo,dist_matrix)
    [n,d] = size(x);
    rein = 0;
    ...
    while W
        ...
        if  gr ~= 0 % Number of centers was degenerated
            W = 1;
            rein = rein + 1;    % Checks how many recurrence
            switch metodo
                case 1     % Randon
